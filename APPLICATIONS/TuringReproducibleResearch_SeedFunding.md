...
4. An easily deployable set of software tools to enable researchers to deploy a reproducible research workflow with little effort. These will package together and build on existing tools such as [Github](https://github.com/alan-turing-institute) (version control), [Docker](https://www.docker.com/) (environment reproducibility), [rOpenSci](https://ropensci.org/) (data access from code) and [Frictionless Data](http://frictionlessdata.io/). With the support of Kenji Takeda, we plan to make deployment of reproducible workflows to the Azure cloud as easy as using these workflows on a researcher's own machine.
